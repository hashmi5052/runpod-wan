...
# -----------------
RUN aria2c -x 4 -s 4 -o ComfyUI/models/diffusion_models/flux1-kontext-dev-Q4_0.gguf \
    https://huggingface.co/QuantStack/FLUX.1-Kontext-dev-GGUF/resolve/main/flux1-kontext-dev-Q4_0.gguf

RUN aria2c -x 4 -s 4 -o ComfyUI/models/vae/ae.safetensors \
    https://huggingface.co/lovis93/testllm/resolve/main/ae.safetensors

RUN aria2c -x 4 -s 4 -o ComfyUI/models/text_encoders/clip_l.safetensors \
    https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/clip_l.safetensors \
 && aria2c -x 4 -s 4 -o ComfyUI/models/text_encoders/t5xxl_fp8_e4m3fn.safetensors \
    https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn.safetensors

# -----------------
# Download Upscalers with aria2c (progress shown)
# -----------------
RUN aria2c -x 4 -s 4 -o ComfyUI/models/upscale_models/RealESRGAN_x2.pth \
    https://huggingface.co/ai-forever/Real-ESRGAN/resolve/a86fc6182b4650b4459cb1ddcb0a0d1ec86bf3b0/RealESRGAN_x2.pth \
 && aria2c -x 4 -s 4 -o ComfyUI/models/upscale_models/RealESRGAN_x4.pth \
    https://huggingface.co/ai-forever/Real-ESRGAN/resolve/a86fc6182b4650b4459cb1ddcb0a0d1ec86bf3b0/RealESRGAN_x4.pth \
 && aria2c -x 4 -s 4 -o ComfyUI/models/upscale_models/RealESRGAN_x8.pth \
    https://huggingface.co/ai-forever/Real-ESRGAN/resolve/a86fc6182b4650b4459cb1ddcb0a0d1ec86bf3b0/RealESRGAN_x8.pth \
 && aria2c -x 4 -s 4 -o ComfyUI/models/upscale_models/4x_foolhardy_Remacri.pth \
    https://huggingface.co/FacehugmanIII/4x_foolhardy_Remacri/resolve/main/4x_foolhardy_Remacri.pth \
 && aria2c -x 4 -s 4 -o ComfyUI/models/upscale_models/4x-UltraSharp.pth \
    https://huggingface.co/lokCX/4x-Ultrasharp/resolve/main/4x-UltraSharp.pth \
 && aria2c -x 4 -s 4 -o ComfyUI/models/upscale_models/4x_NMKD-Siax_200k.pth \
    https://huggingface.co/gemasai/4x_NMKD-Siax_200k/resolve/main/4x_NMKD-Siax_200k.pth \
 && aria2c -x 4 -s 4 -o ComfyUI/models/upscale_models/8x_NMKD-Superscale_150000_G.pth \
    https://huggingface.co/uwg/upscaler/resolve/main/ESRGAN/8x_NMKD-Superscale_150000_G.pth \
 && aria2c -x 4 -s 4 -o ComfyUI/models/upscale_models/8x_NMKD-Faces_160000_G.pth \
